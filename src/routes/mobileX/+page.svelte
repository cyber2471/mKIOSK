<script>
	...
	// let mgoodstb = liveQuery(() => db.mgoodstb.toArray())
	// const mgoodstb = []
    // let mgoodstb;

	// onMount(async () => {
	// 	mgoodstb = liveQuery( async () => db.mgoodstb.toArray())
	// 	tick(() => console.log('Before Destroy!'))
...
//     // Query Dexie's API
//     //
//     const mgoodstb = await db.mgoodstb
//       .where('id')
//       .between(1, 3)
//       .toArray();

// 	  console.log("mgoodstb:",mgoodstb)

//     return  await mgoodstb
//       ;
//   });

//   $: mgoodstb, (() => console.log("mgoodstb:",mgoodstb)) ();
...
<div class="container">
	<div class="itemGrid">
		...
		{#if mgoodstb}
		{#each mgoodstb as {name, price}, id}
			<Box>
				<center >
  ...
  <!-- <div>{console.log("mgoodstb:",mgoodstb)}</div> -->
